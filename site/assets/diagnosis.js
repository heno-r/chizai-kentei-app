...
const RESULTS = {
    beginner: {
        ...
        copy: "基礎論点を短く反復できる形が合いそうです。まずは無料版で出題形式に慣れて、必要を感じたら3級プレミアム版の案内へ進む流れが自然です。",
    ...
    focused: {
        ...
        copy: "基礎知識はあるので、苦手論点の整理と反復が鍵です。無料版で触り心地を確認したうえで、3級プレミアム版の内容を見て次の一歩を決めるのが合っています。",
    ...
    ambitious: {
        ...
        copy: "学習時間を確保できそうなので、まずは3級を短期間で安定させる進め方が向いています。苦手復習や直前14日モードを活かせるかどうかを、3級プレミアム版の案内で確認するのがおすすめです。",
        plan: "3級プレミアム版 1,200円 / 追加月額料金なし",
        action: "3級プレミアム版の内容を見る",
        href: "/premium/",
    },
