(function attachPremiumGuidePage(): void {
  const runtimeConfig = window.APP_RUNTIME_CONFIG || {};
  const fitCheckButton = document.getElementById("fit-check-button") as HTMLButtonElement | null;
  const purchaseReadyButton = document.getElementById("purchase-ready-button") as HTMLButtonElement | null;
  const purchaseFlowButton = document.getElementById("purchase-flow-button") as HTMLButtonElement | null;
  const deviceCheckButton = document.getElementById("device-check-button") as HTMLButtonElement | null;
  const fitMessage = document.getElementById("premium-fit-message") as HTMLElement | null;
  const purchaseMessage = document.getElementById("premium-purchase-message") as HTMLElement | null;
  const flowMessage = document.getElementById("premium-flow-message") as HTMLElement | null;
  const deviceMessage = document.getElementById("premium-device-message") as HTMLElement | null;
